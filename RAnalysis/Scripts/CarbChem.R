...
#############################################################
setwd("C:/Users/samjg/Documents/My_Projects/Juvenile_geoduck_OA/RAnalysis/Data/Chemistry.flow") #set working directory
#setwd("~/MyProjects/Geoduck_Conditioning/RAnalysis/Data") #set working directory
mainDir<-'C:/Users/samjg/Documents/My_Projects/Juvenile_geoduck_OA/RAnalysis/' #set main directory
...
path <-("C:/Users/samjg/Documents/My_Projects/Juvenile_geoduck_OA/RAnalysis/Data/Chemistry.flow/pH_Calibration_Files")
...
pdf("C:/Users/samjg/Documents/My_Projects/Juvenile_geoduck_OA/RAnalysis/Output/Daily_Treatment_Measures.pdf")
par(mfrow=c(3,2))
...
write.table(carb.output, "C:/Users/samjg/Documents/My_Projects/Juvenile_geoduck_OA/RAnalysis/Output/Seawater_chemistry_table_Output_All.csv", sep=",", row.names = FALSE) #save data
...
# CHECK YOUR Y AXIS!
pdf("C:/Users/samjg/Documents/My_Projects/Juvenile_geoduck_OA/RAnalysis/Output/Water_Chem_withTA.pdf")
par(mfrow=c(3,2))
